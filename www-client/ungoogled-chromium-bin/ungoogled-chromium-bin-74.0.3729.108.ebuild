...
HOMEPAGE="https://github.com/leo-lb/ungoogled-chromium"
SRC_URI="https://github.com/leo-lb/ungoogled-chromium/releases/download/ungoogled-chromium-ppc64le-${PV}-buildscript/ungoogled-chromium-ppc64le-${PV}.7z -> ${PN}-${MY_PV}.7z"
RESTRICT="mirror"
