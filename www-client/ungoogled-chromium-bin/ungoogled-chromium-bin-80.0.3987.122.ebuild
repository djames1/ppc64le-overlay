...
SRC_URI="https://github.com/chromium-ppc64le/chromium-ppc64le/releases/download/v80.0.3987.122-1/ungoogled-chromium-browser-stable-${PV}-1.tar.xz -> ${PN}-${MY_PV}.tar.xz"
RESTRICT="mirror"
