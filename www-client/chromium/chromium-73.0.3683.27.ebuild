...
PATCHES=(
  ...
  "${FILESDIR}/0001-sandbox-linux-bpf_dsl-Update-syscall-ranges-for-ppc6.patch"
  "${FILESDIR}/0002-sandbox-linux-bpf_dsl-Modify-seccomp_macros-to-add-s.patch"
  "${FILESDIR}/0003-sandbox-linux-system_headers-Update-linux-seccomp-he.patch"
  "${FILESDIR}/0004-sandbox-linux-system_headers-Update-linux-signal-hea.patch"
  "${FILESDIR}/0005-sandbox-linux-seccomp-bpf-Add-ppc64-syscall-stub.patch"
  "${FILESDIR}/Sandbox-linux-services-credentials.cc-PPC.patch"
  ...
  "${FILESDIR}/0001-sandbox-linux-Update-IsSyscallAllowed-in-broker_proc.patch"
  "${FILESDIR}/0001-linux-seccomp-bpf-ppc64-glibc-workaround-in-SIGSYS-h.patch"
  "${FILESDIR}/0001-components-update_client-Fix-building-on-ppc64.patch"
  "${FILESDIR}/0001-base-allocator-Use-64k-page-sizes-on-ppc64.patch"
  "${FILESDIR}/0001-Properly-detect-little-endian-PPC64-systems.patch"
  "${FILESDIR}/Modules-desktop_capture-differ_block.cc-PPC.patch"
  "${FILESDIR}/Buildtools-third_party-libc++-trunk-include-thread-PPC.patch"
  "${FILESDIR}/Rtc_base-system-arch.h-PPC.patch"
  "${FILESDIR}/0001-third_party-angle-Include-missing-header-cstddef-in-.patch"
  "${FILESDIR}/0001-third_party-lss-Don-t-look-for-mmap2-on-ppc64.patch"
  "${FILESDIR}/0001-DONTMERGE-third_party-node-Use-system-nodejs-binary.patch"
  "${FILESDIR}/0002-third_party-closure_compiler-Remove-useless-JVM-flag.patch"
  "${FILESDIR}/0001-third_party-blink-Fix-build-on-ppc64.patch"
  "${FILESDIR}/0001-Reenable-VSX-in-libpng.patch"
  "${FILESDIR}/0001-third_party-libvpx-Properly-generate-gni-on-ppc64.patch"
  "${FILESDIR}/0001-third_party-blink-Add-SaveRegisters-implementation-w.patch"
  "${FILESDIR}/0002-third_party-libvpx-Add-ppc64-sources-to-gni.patch"
  ...
  "${FILESDIR}/Chromium-blink-snapcontainerdata.patch"
